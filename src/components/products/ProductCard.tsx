        ...
        <div className={cn("flex flex-1 flex-col", compact ? "p-3" : "p-4 md:p-5")}>
          ...
          <div className={cn("mt-auto flex items-center gap-2", compact ? "pt-2" : "pt-4")}>
            ...
            <a
              ...
              className="flex shrink-0 cursor-pointer items-center justify-center p-1 text-[#25D366] transition-transform hover:scale-110"
              aria-label="WhatsApp"
            >
              <svg className={cn(compact ? "h-6 w-6" : "h-7 w-7")} fill="currentColor" viewBox="0 0 24 24">
